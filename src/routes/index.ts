...
indexRoutes.post("/analytics/", async (req: Request, res: Response) => {
  await prisma.visits.create({ data: { device: req.body.device } });
  res.status(200);
});
...
indexRoutes.get("/formatted", async (req: Request, res: Response) => {
