/*
  ...
  - Added the required column `isBreak` to the `Tempo` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Tempo" ("day_index", "horario", "id", "materia", "professorId", "turmaId") SELECT "day_index", "horario", "id", "materia", "professorId", "turmaId" FROM "Tempo";
DROP TABLE "Tempo";
